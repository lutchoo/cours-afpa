...
function singIn($email, $password) {
    ...
    if($count > 0){
        header('location:newuser.php?message=adresse mail deja utiliser&status=danger');
        ...
        $stmt->execute();
        header('location:newuser.php?message=utilisateur enregistrer&status=success');
    }
}
