...
if(isset($_POST) && !empty($_POST)){
    if($_POST['password_confirm']=== $_POST['password']){
      ...
      if($email){
        ...
        header('location:newuser.php?message=adresse mail non valide&status=danger');
      }
    }else{
      echo 'le mot de passe ne correspond pas';
      header('location:newuser.php?message=le mot de passe ne correspond pas&status=danger');
    }
